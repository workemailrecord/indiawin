...
const jslotsPage = async (req, res) => {
    return res.render("api/jslots.ejs");
}

const alllotPage = async (req,res) => {
    return res.render("api/alllot.ejs");
}

const allcasinoPage = async (req,res) => {
    return res.render("api/allcasino.ejs");
}

const alljdbPage = async (req,res) => {
    return res.render("jdb/all.ejs");
}

const allspribePage = async (req,res) => {
    return res.render("api/allspribe.ejs")
}

const allmancalaPage = async (req, res) => { 
    return res.render("api/allmancala.ejs");
}

const allgtfPage = async (req, res) => { 
    return res.render("api/allgtf.ejs");
}

const allfcPage = async (req, res) => { 
    return res.render("api/allfc.ejs");
}

const allambPage = async (req, res) => {
    return res.render("api/allamb.ejs");
}

const alljiliPage = async (req, res) => {
    return res.render("jili/slots.ejs");
}

const allybPage = async (req, res) => {
    return res.render("api/allyb.ejs");
}

const allhrgPage = async (req,res) => {
    return res.render("api/allhrg.ejs");
}

const allonplayPage = async (req,res) => {
    return res.render("api/allonplay.ejs");
}

const allinjoyPage = async (req,res) => {
    return res.render("api/allinjoy.ejs");
}

const allswgPage = async (req,res) => {
    return res.render("api/allswg.ejs");
}
