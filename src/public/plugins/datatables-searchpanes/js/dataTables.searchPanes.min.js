  ...
  function (n) {
    return n
      ...
      : function (q, l) {
          return (
            -1 !==
            $jscomp.checkStringArgs(this, q, "includes").indexOf(q, l || 0)
          );
        };
  },
  "es6",
      ...
      function h(a, b, c, e, d, f) {
        ...
        this.dom = {
          ...
          container: l("<div/>")
            ...
            .addClass(
              this.classes.layout + (10 > b ? e : e.split("-")[0] + "-9"),
            ),
            ...
            0 === c.arrayFilter.length
              ...
              : this.c.cascadePanes &&
                  this.s.dt.rows().data().toArray().length ===
                    this.s.dt.rows({ search: "applied" }).data().toArray()
                      .length
      ...
      h.prototype.resizePanes = function () {
        if ("auto" === this.c.layout) {
          ...
          for (d = this.s.panes; b < d.length; b++)
            (g = d[b]),
              g.s.displayed &&
                ((f = "columns-" + (e.includes(g.s.index) ? c : a)),
                g.resize(f));
        } else
          ...
          for (
            var c = function (f) {
                if (f.s.index === a[b].index && void 0 !== f.s.dtPane) {
                  ...
                  f.s.dtPane.draw();
                  f.s.dtPane.table().node().parentNode.scrollTop =
                    f.s.scrollTop;
                  f.s.lastCascade = !1;
                }
              },
      ...
      h.prototype._serverTotals = function () {
        ...
        for (e = this.s.panes; b < e.length; b++)
          (d = e[b]),
            ...
            void 0 !== d.s.dtPane &&
              ((v(d.s.dtPane.table().node()).parent()[0].scrollTop =
                d.s.scrollTop),
